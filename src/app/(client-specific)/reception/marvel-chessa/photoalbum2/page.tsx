...
export default function PhotoAlbum2() {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          className="ml-[8%] w-[50%] sm:ml-[5%] sm:w-[50%] md:ml-[10%] md:w-[45%] lg:ml-[20%] lg:w-[35%] 2xl:ml-[10%] 2xl:mt-40 2xl:w-[33%]"
          src={img14}
          alt="IMG14"
          width={800}
          height={800}
      ...
      >
        <Image
          className="-mt-20 ml-auto mr-[8%] w-[55%] sm:-mt-24 sm:mr-[5%] sm:w-[45%] md:-mt-28 md:mr-[10%] md:w-[50%] lg:-mt-20 lg:mr-[20%] lg:w-[37%] 2xl:-mt-40 2xl:mr-[10%] 2xl:w-[35%]"
          src={img15}
          alt="IMG15"
          width={800}
          height={800}
